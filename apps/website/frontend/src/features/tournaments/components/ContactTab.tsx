            ...
            {emailContacts.map((contact, idx) => (
              <div key={idx} style={{ display: "flex", alignItems: "center", gap: "0.75rem", flexWrap: "wrap" }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem" }}>
                  ...
                  <span className="sbLabel" style={{ margin: 0, fontSize: "14px" }}>
              ...
              return (
                <div key={idx} style={{ display: "flex", alignItems: "center", gap: "0.75rem", flexWrap: "wrap" }}>
                  <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem" }}>
                    ...
                    <span className="sbLabel" style={{ margin: 0, fontSize: "14px" }}>
                      {inviteHref ? label : contact.value}
                    </span>
                  </div>
            ...
            {phoneContacts.map((contact, idx) => (
              <div key={idx} style={{ display: "flex", alignItems: "center", gap: "0.75rem", flexWrap: "wrap" }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem" }}>
                  ...
                  <span className="sbLabel" style={{ margin: 0, fontSize: "14px" }}>Phone</span>
                </div>
