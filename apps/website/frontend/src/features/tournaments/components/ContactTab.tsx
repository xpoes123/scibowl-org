              ...
              {discordContacts.map((contact, idx) => {
                ...
                return (
                  <div key={idx} style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    {href ? (
                      <a href={href} target="_blank" rel="noreferrer" className="sbInlineLink sbInlineLinkSmall">
                        <svg
                          width="20"
                          height="20"
                          viewBox="0 0 24 24"
                      ...
                      <>
                        ...
                        <span className="sbLabel" style={{ margin: 0, fontSize: "14px" }}>Discord</span>
                        <span style={{ fontFamily: "monospace", color: "var(--sb-text)" }}>{contact.value}</span>
                      </>
                    )}
                  </div>
                );
